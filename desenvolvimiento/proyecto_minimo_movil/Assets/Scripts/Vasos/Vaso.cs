...
public class Vaso : MonoBehaviour
{
    ...
    void Update(){
        ...
        if (move){
            transform.position = new Vector2(Mathf.Lerp(transform.position.x,nextPosition.position.x,0.1f),Mathf.Lerp(transform.position.y,nextPosition.position.y,0.05f));
